...
public class SepetHesap {
    ...
    public static double calculateGrandTotal(double discountedTotal, double vatAmount, double shippingFee) {
        //Genel Toplam = indirimliTutar + kdvTutarı + kargoÜcreti
    ...
    public static void main(String[] args) {
        ...
        //İndirim Bilgisi
        System.out.println("\nİndirim Kodu Yüzdesi (%): ");
        double discountPercent = input.nextDouble();

        //Hesaplamalar

        //Ürünlerinsatış toplamlarını hesapla
       ...
       //İndirimli toplamı hesapla
        ...
        //KDV tutarını hesapla (İndirimli toplam üzerinden)
